...
using Greenwolf.SportsStats.Data;
using Volo.Abp.Data;
...
public class MongoDbSportsStatsDbSchemaMigrator : ISportsStatsDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbSportsStatsDbSchemaMigrator(IServiceProvider serviceProvider)
    {
